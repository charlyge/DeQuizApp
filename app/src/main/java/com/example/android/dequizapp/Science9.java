...
public class Science9 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_science9);
        Submit();
    }
    ...
    public void isAnswer(){
        ...
        if(rb.isChecked()){
            ...
            Toast toast = new Toast(Science9.this);
        ...
        Toast.makeText(Science9.this,currentScore,Toast.LENGTH_LONG).show();
    }
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Science9.this,MainActivity.class);
        startActivity(intent);
        gotIt=0;
    }
}
