...
public class Science3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science3);
    ...
    public void isAnswer(){
        ...
        if(rb.isChecked()){
            gotIt=gotIt+1;
            Toast toast = new Toast(Science3.this);
        ...
        Toast.makeText(Science3.this,currentScore,Toast.LENGTH_LONG).show();
    }
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Science3.this,MainActivity.class);
        startActivity(intent);
        gotIt=0;
    }
}
