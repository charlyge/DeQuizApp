...
public class Science6 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_science6);
        Submit();
    }
    ...
    public void isAnswer(){
        ...
        if(rb.isChecked()){
            ...
            Toast toast = new Toast(Science6.this);
        ...
        Toast.makeText(Science6.this,currentScore,Toast.LENGTH_LONG).show();
    }
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Science6.this,MainActivity.class);
        startActivity(intent);
        gotIt=0;
    }
