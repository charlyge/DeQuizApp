...
public class Science10 extends AppCompatActivity {
    ...
    public void isAnswer(){
        ...
        if(rb.isChecked()){
            ...
            Toast toast = new Toast(Science10.this);
        ...
        Toast.makeText(Science10.this,currentScore,Toast.LENGTH_LONG).show();
    }
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Science10.this,MainActivity.class);
        startActivity(intent);
        gotIt=0;
    }
}
