...
public class Science4 extends AppCompatActivity {
    ...
    public void isAnswer() {
        ...
        if (rb.isChecked()) {
            ...
            Toast toast = new Toast(Science4.this);
        ...
        Toast.makeText(Science4.this, currentScore, Toast.LENGTH_LONG).show();
    }
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Science4.this, MainActivity.class);
        startActivity(intent);
        gotIt = 0;
    }
}
