...
public class Science8 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_science8);
        Submit();
    }
    ...
    public void isAnswer(){
        ...
        if(rb.isChecked()){
            ...
            Toast toast = new Toast(Science8.this);
            View view1 =getLayoutInflater().inflate(R.layout.toast2,(ViewGroup)findViewById(R.id.toastView));
            toast.setView(view1);
            toast.show();
            ...
            Toast toast = new Toast(Science8.this);
            View view1 =getLayoutInflater().inflate(R.layout.toast5,(ViewGroup)findViewById(R.id.toastView));
            toast.setView(view1);
            toast.show();
            toast.setDuration(Toast.LENGTH_SHORT);
        }
        ...
        Toast.makeText(Science8.this,currentScore,Toast.LENGTH_LONG).show();
    }
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Science8.this,MainActivity.class);
        startActivity(intent);
        gotIt=0;
    }
}
