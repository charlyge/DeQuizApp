...
public class Science2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new word("1. This is the Second Question","Answer11","Answer22","Answer33","Answer44"));
    ...
    public void isAnswer(){
        ...
        if(rb.isChecked()){
            ...
            Toast toast = new Toast(Science2.this);
        ...
        Toast.makeText(Science2.this,currentScore,Toast.LENGTH_LONG).show();
    }
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Science2.this,MainActivity.class);
        startActivity(intent);
        gotIt=0;
    }
}
